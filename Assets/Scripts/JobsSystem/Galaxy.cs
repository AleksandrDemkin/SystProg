...
namespace JobsSystem
{
    public class Galaxy : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            Transform[] _transforms = new Transform[_numberOfEntities];
            ...
            for (int i = 0; i < _numberOfEntities; i++)
            {
                ...
                _transforms[i] = Instantiate(_celestialBodyPrefab).transform;
            }
            
            _transformAccessArray = new TransformAccessArray();
        }
